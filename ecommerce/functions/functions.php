...
//creating the cart
 function cart(){
 	if(isset($_GET['add_cart'])){
 		...
 		$check_pro = "selct * from cart where ip_add='$ip' AND p_id='$pro_id'";
...
function getCatPro(){
	...
	if (isset($_GET['cat'])) {
	 ...
	 if ($count_cats ==0) {
	 	echo "<h2 style='padding:20px;'>No products in this category!</h2>";
	 }
...
function getBrandPro(){
	...
	if (isset($_GET['brand'])) {
	 ...
	 if ($count_brands ==0) {
	 	echo "<h2 style='padding:20px;'>No products found associated with this brand!</h2>";
	 }
